    ...
    unicorn.configs.recommended,
    {
        ...
        rules: {
            ...
            "no-restricted-syntax": [
                ...
                {
                    selector:
                        "CallExpression[callee.property.name='toArray'] MemberExpression[object.callee.property.name='map']",
                    message: "Please use .toArray() before .map().",
                },
                {
                    selector:
                        'CallExpression[callee.property.name="catch"] > ArrowFunctionExpression[params.length=0][body.value=null]',
                    message:
                        "Usage of .catch(() => null) is not allowed. Please handle the error appropriately.",
                },
                {
                    selector:
                    ...
                    message:
                        "Usage of .catch(() => undefined) is not allowed. Please handle the error appropriately.",
                },
                {
                    selector:
                        'CallExpression[callee.property.name="catch"] > ArrowFunctionExpression[params.length=0] > ArrayExpression[elements.length=0]',
                    message:
                        "Usage of .catch(() => []) is not allowed. Please handle the error appropriately.",
                },
                {
                    selector:
